...
async def on_raw_reaction_add(payload):
  ...
  # --- ระบบเดิม: กด ✅ ในห้องต้อนรับ/กฎ รับยศ Beluga ตัวน้อย ---
  if getattr(channel, 'name', None) in RULES_REACT_CHANNELS and str(payload.emoji) == RULES_REACT_EMOJI:
    ...
    try:
      ...
      await channel.send(f'🗿 {member.mention} กด ✅ รับกฎแล้ว ยินดีด้วย ได้ยศ **{RULES_REACT_ROLE_NAME}** ไปเลย!')
  ...
  if getattr(channel, 'name', None) == ROLE_CLAIM_CHANNEL_NAME and str(payload.emoji) in ROLE_CLAIM_MAP:
    ...
    try:
      await member.add_roles(role)
      await channel.send(f'🎉 {member.mention} อยู่ครบ {min_days} วันแล้ว ได้รับยศ **{role_name}** เรียบร้อย!')
    except discord.Forbidden:
...
async def grant_pioneer_role_if_eligible(member, channel):
  ...
  try:
    ...
    if channel is not None:
      await channel.send(
          f'🏆 ยินดีด้วย! {member.mention} คือผู้บุกเบิกคนที่ **{position}/{PIONEER_LIMIT}** ของเซิร์ฟนี้'
...
async def on_member_join(member):
  ...
  welcome_messages = [
      # กวนล้วนๆ (ของเดิม)
      f'🗿 อ้าวเฮ้ย {member.mention} เข้ามาทำไมอ่ะ ที่นี่ไม่มีอะไรดีให้หรอกนะ',
      f'🗿 ยินดีต้อนรับ {member.mention} เข้าสู่เซิร์ฟที่พังที่สุดในจักรวาล 🎉',
      f'🗿 {member.mention} มาแล้ว! เตรียมตัวโดนแกล้งได้เลยจ้า',
      f'🗿 เอ้า สมาชิกใหม่ {member.mention} ดูท่าทางแล้วอยู่ได้ไม่เกิน 3 วันแน่นอน',
      f'🗿 {member.mention} เข้ามาแบบไม่มีใครเชิญเลยนะ กล้ามาก',
      f'🗿 ยินดีต้อนรับสู่คุกที่ไม่มีทางออก {member.mention} 😈',
      f'🗿 {member.mention} หวังว่าจะทนคนในนี้ได้นะ กูก็ไม่ค่อยมั่นใจเท่าไหร่',
      f'🗿 อุ๊ยตายวายป่วง มีคนใหม่ {member.mention} เข้ามาสมัครเป็นตัวตลกคนต่อไป',
      f'🗿 {member.mention} มาแล้วจ้า... ใครก็ได้บอกมันหน่อยว่าที่นี่ไม่ปกติ',
      # จริงใจแต่กวนตีน (ของใหม่)
      f'🗿 ยินดีต้อนรับนะ {member.mention} จริงๆ นะ ไม่ได้กวน... โอเคกวนนิดหน่อย แต่ดีใจที่มึงมาจริงๆ',
      f'🗿 เฮ้ {member.mention} เข้ามาแล้วนะ บอกตรงๆ ว่าดีใจ (แต่ก็แอบสงสัยว่ามึงมาถูกที่รึเปล่า)',
      f'🗿 {member.mention} มาถึงแล้ว! เซิร์ฟนี้อาจดูป่วนๆ แต่ทุกคนที่นี่ยินดีต้อนรับมึงจริงๆ นะ (กวนได้ แต่ใจดีเสมอ)',
      f'🗿 ต้อนรับ {member.mention} เข้าสู่ครอบครัวสุดกวนของเรา พูดตรงๆ คือดีใจที่มึงเลือกมาอยู่ที่นี่',
      f'🗿 {member.mention} เข้ามาแล้วเหรอ... งั้นเตรียมโดนแกล้งได้เลย (ล้อเล่นนะ ยินดีต้อนรับจริงๆ ครับ)',
      f'🗿 ไม่รู้จะพูดจริงจังยังไงดี งั้นพูดแบบกวนๆ ก็ได้: ยินดีที่ได้รู้จัก {member.mention} หวังว่าจะสนุกกับที่นี่นะ',
  ]
  ...
  role_nudges = [
      '🐣 อ้อ ตอนนี้มึงยังพูดในเซิร์ฟไม่ได้นะ ไปกด ✅ ในห้อง #กฎ ซะ จะได้ยศ "Beluga ตัวน้อย" แล้วค่อยมาคุยกับกูได้',
      '🐣 เป็นใบ้อยู่แบบนี้ไปอีกนานนะถ้าไม่ไปรับยศ "Beluga ตัวน้อย" ที่ห้อง #กฎ รีบไปกด ✅ ซะ',
      '🐣 ยศตอนนี้พูดไม่ได้นะจ๊ะ ไปที่ห้อง #กฎ กด ✅ รับยศ "Beluga ตัวน้อย" ก่อน แล้วค่อยมากวนกับกูต่อ',
      '🐣 เสียดายนะ มึงยังแชทไม่ได้เพราะไม่มียศ ไปห้อง #กฎ กด ✅ รับ "Beluga ตัวน้อย" ซะเร็วๆ นี่',
      '🐣 แนะนำให้รีบไปห้อง #กฎ กด ✅ รับยศ "Beluga ตัวน้อย" ไม่งั้นได้แต่ยืนมองคนอื่นคุยกันไปอีกนาน',
  ]
